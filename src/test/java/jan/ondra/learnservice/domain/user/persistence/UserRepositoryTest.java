...
//
//            verify(userCache).put("authSubject-1", id);
//        }
//
//        @Test
...
//
//            when(userCache.get("authSubject-1", UUID.class)).thenReturn(id);
//
//            assertThat(userRepository.getUserIdByAuthId("authSubject-1")).isEqualTo(id);
//        }
//
//        @Test
//        @DisplayName("returns correct user ID when user ID was not cached")
//        void test2() {
//            when(userCache.get("authSubject-1", UUID.class)).thenReturn(null);
//
//            var id = insertUser(
//                new User(
//                    null,
...
//            );
//
//            assertThat(userRepository.getUser("authSubject-1")).isEqualTo(user);
//
//            verify(userCache).put("authSubject-1", user.id());
//        }
//
//    }
//
...
//            );
//
//            userRepository.deleteUser("authSubject-2");
//
//            assertThat(selectAllUsers()).containsExactly(user);
//
//            verify(userCache).evict("authSubject-2");
//        }
//
//    }
//
